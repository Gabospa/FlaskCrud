...
app.config['MYSQL_USER'] = 'gabospa'
app.config['MYSQL_PASSWORD'] = 'patofeliz'
app.config['MYSQL_DB'] = 'flaskcontacts'
mysql = MySQL(app)

#Para inicializar sesion. Almacena datos nuestra aplicacion de servidor, que luego podran ser reutilizados
# settings
